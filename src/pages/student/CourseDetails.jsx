...
function CourseDetails() {
  ...
  const [isAllredyEndrolled,setIsAllredyEndrolled] = useState(false)
  ...
  return courseData ? (
     ...
     <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left '>
       ...
       <div className='max-w-xl z-10 text-gray-500'>
        ...
        <p className='text-sm'>Course by <span className='text-blue-600 underline'>Chetan Verma</span></p>
                ...
                <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                   <div className='flex items-center justify-between px-4 py-3 cursor-pointer select-none' onClick={()=>toggleSection(index)}>
                    <div className='flex items-center gap-2'>
                      <img className={`transform transtition-transform ${openSections[index]?'rotate-180':''}`} src={assets.down_arrow_icon} alt="down_arrow_icon" />
       ...
       <div className='max-w-[424px] z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
         ...
         <div className='p-5 '>
            ...
            <button className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium'>{isAllredyEndrolled?'Allredy Enrolled':'Enroll Now'}</button>
            <div className='pt-6'>
              <p className='md:text-xl text-lg font-medium text-gray-800'>What's in the course?</p>
              <ul className='ml-4 pt-2 text-sm md:text-lg list-disc text-gray-500'>
                <li>Lifetime access with free updates?</li>
                <li>Step-by-step teach the project with guildenss</li>
                <li>Dowloads resourses and sourse code </li>
                <li>Quezzess to test your knowlege</li>
                <li>Certificate of completation</li>
              </ul>
            </div>
         </div>
       </div>
